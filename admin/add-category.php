        ...
        <form action="" method="POST" enctype="multipart/form-data">
             ...
             <table class="tbl-30">
                <tr>
                    <td>Title: </td>
                    <td>
                        <input type="text" name="title" placeholder="Categroy Title">
                    </td>    
                </tr>
    ...
    <?php 
          ...
          if(isset($_POST['submit']))
          {
            ...
            else 
            {
             ...
             {
                //upload the image 
                //to upload image we need iamge name,source path and destination path
                $image_name = $_FILES['image']['name'];

                //upload te image only if image is selected
                if($image_name != "")
                {
