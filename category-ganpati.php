...
?>
    ...
    <section class="ganpati-search text-center">
        <div class="container">
            ...
            <h2>Ganpati of <a href="#" class="text-white">"<?php echo $category_title;?>"</a></h2>
    ...
    <section class="ganpati-menu">
        <div class="container">
            ...
            <?php 
                $sql2 = "SELECT * FROM table_ganpati WHERE category_id=$category_id";
                        ...
                        ?>
                            <div class="ganpati-menu-box">
                                ...
                                <?php 
                                    ...
                                    ?>
                                    <img src="images/ganpati42.jpg" alt="lalbag" class="img-responsive img-curve">
                                </div>
